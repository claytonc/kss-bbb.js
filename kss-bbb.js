/*Products.CMFPlone.skins.plone_ecmascript.kss-bbb.js*/
(function($){
...
$(document).ready(function(){
    ...
    function updateSharing(data){
        ...
        var messages = $(data.messages).filter(function(){ return $('#kss-portal-message') });
    ...
    /* Removido para não começar a buscar antes de colocar o nome do usuário completo */
    /* sharing search form */
